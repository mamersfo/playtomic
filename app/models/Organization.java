...
public class Organization
{
    ...
    public Organization( JsonNode node )
    {
        ...
        this.orgtype = JsonUtil.asString( JsonUtil.getKeywordValue( node, ORGTYPE ) );     
        
        if ( node.get( PARENT ) != null )
        {
            Entity entity = JsonUtil.getEntityValue( node.get( PARENT ), "db/id" );
    ...
    public Organization( Entity entity )
    {
        ...
        this.orgtype = JsonUtil.asString( (Keyword)entity.get( ORGTYPE ) );
